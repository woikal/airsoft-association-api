...
return [
     ...
     */
    'fonts'      => [
        'default' => 'http://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,700;1,400;1,700',
        'code'    => 'http://fonts.googleapis.com/css2?family=IBM+Plex+Mono:ital,wght@0,400;0,700;1,400&display=swap',
    ],
